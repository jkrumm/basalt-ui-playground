...
// dark-gray-1 / dark-gray-4 backgrounds, Blueprint semantic colors for tokens
export const blueprintDarkTheme: ThemeRegistration = {
  ...
  tokenColors: [
    ...
    {
      scope: ['entity.name.type', 'entity.name.class', 'entity.other.inherited-class', 'support.class'],
