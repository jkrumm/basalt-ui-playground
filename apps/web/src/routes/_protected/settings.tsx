...
export const Route = createFileRoute('/_protected/settings')({
  // Loader preload intentionally omitted: getApi's server branch creates a direct
  // in-process Elysia call without forwarding request cookies, so authenticated
  // queries would return 401 during SSR. useSuspenseQuery runs client-side after
  // hydration where credentials: 'include' sends the auth cookie correctly.
