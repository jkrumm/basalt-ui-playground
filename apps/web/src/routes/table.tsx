    ...
    <Box className={styles.page}>
      <Box className={styles.container}>
        ...
        <Callout intent={Intent.WARNING} icon={null} style={{ marginBottom: 16 }}>
          ...
          manipulates
          <Code>scrollLeft</Code>/<Code>scrollTop</Code> during render. SSR crashes without an{" "}
          <Code>isMounted</Code> guard. Use this in authenticated dashboards where virtualized
          scrolling, frozen columns, and spreadsheet-style UX matter. SEO is irrelevant behind auth.
        </Callout>
